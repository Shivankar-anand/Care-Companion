...
public class ChangeLocationDoc extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_location_doc);
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mapFragment.getMapAsync(ChangeLocationDoc.this);
                }
            }
        });
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markerCenter = mMap.addMarker(markerOptions.icon(BitmapDescriptorFactory
        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference databaseReference = FirebaseDatabase.getInstance()
                        .getReference("Doctors_type").child(user.getUid());
                ...
                Intent intent = new Intent(ChangeLocationDoc.this, DoctorHomepage.class);
