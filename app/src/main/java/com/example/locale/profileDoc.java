...
public class profileDoc extends AppCompatActivity implements View.OnClickListener{

    private LinearLayout review, call, message, directions;
    TextView Name;
    TextView Category;
    TextView nrate, avrate, exp, qua;
    ImageView DP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exp = findViewById(R.id.experienceTV);
        qua = findViewById(R.id.qualificationTV);
        pay.setOnClickListener(this);
        final String name = getIntent().getStringExtra("name");
        final String category = getIntent().getStringExtra("category");
        final String dpURL = getIntent().getStringExtra("dp");
        final String phone = getIntent().getStringExtra("phone");
        final String experience = getIntent().getStringExtra("experience");
        final String qualification = getIntent().getStringExtra("qualification");
        ...
        Picasso.with(profileDoc.this).load(dpURL).into(DP);
        Name.setText(name);
        Category.setText(category);
        exp.setText(experience+" Years");
    ...
    private void showRatingDialog() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(profileDoc.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                userid = getIntent().getStringExtra("userid");
                DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Doctors_type").child(userid);
                numRate++;
    ...
    private void showRequestDialog()
    {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!datetext.equals("") && !timetext.equals("") && !destext.equals("")){
                    Toast.makeText(profileDoc.this,"Request Sent",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(profileDoc.this,"Fill out all the fields",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(profileDoc.this,
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(profileDoc.this,
                        AlertDialog.THEME_HOLO_DARK,
                        onTimeSetListener,
                        hour,min,false);
    ...
    private void showPayDialog() {
        ...
        final AlertDialog dialog = mBuilder.create();
        dialog.show();
        RelativeLayout paytm = mView.findViewById(R.id.paytm);
        ...
        RelativeLayout cash = mView.findViewById(R.id.cash);
        cash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(profileDoc.this, "Cash mode selected", Toast.LENGTH_LONG).show();
                dialog.cancel();
            }
        });
    }
    ...
    public void onClick(View view) {
        ...
        {   Bundle b = getIntent().getExtras();
            Intent intent = new Intent(profileDoc.this, MapDirections.class);
            intent.putExtras(b);
            startActivity(intent);
        }
        if(view == message)
        {
            Intent intent = new Intent(profileDoc.this,DocChat.class);
            intent.putExtra("userid",getIntent().getStringExtra("userid"));
            intent.putExtra("type","Doctor_type");
