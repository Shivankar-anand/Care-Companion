...
public class selectDoctors extends AppCompatActivity {
    ...
    private DocListAdapter useradapter;
    ...
    public void readUsers() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Doctors_type");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                useradapter = new DocListAdapter(selectDoctors.this, musers);
