...
public class DocChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call = findViewById(R.id.chat_call);
        ...
        if(type.equals("Patient")){
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    Picasso.with(DocChat.this).load(s.getProfilePicUrl()).into(dp);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(DocChat.this,"Type a message to send",Toast.LENGTH_SHORT).show();
                }
                message.setText("");
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    messageAdapter = new MessageAdapter(DocChat.this,mchat,imageurl);
