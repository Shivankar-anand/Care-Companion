...
public class CreateAccount<findView> extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Button next, submit, docNext;
    Spinner cityList, categories, doctorCategories;
    Bundle bundle;
    RadioGroup gender, accType;
    RadioButton male, female, others, typecus, typeser, typedoctor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typedoctor = (RadioButton) findViewById(R.id.checkDoctor);
        accType = (RadioGroup) findViewById(R.id.acctype);
        doctorCategories = (Spinner) findViewById(R.id.doctor_categories);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if (categories.getSelectedItem().toString().matches("Select Ambulance Type")) {
                    Toast toast = Toast.makeText(getApplicationContext(),
        ...
        docNext = (Button) findViewById(R.id.btnDocNext);
        docNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String firstname = firstName.getText().toString().trim();
                final String lastname = lastName.getText().toString().trim();
                ...
                final String pword = password.getText().toString();
                final String cpword = cpassword.getText().toString();
                final String category = doctorCategories.getSelectedItem().toString();
                ...
                else if (doctorCategories.getSelectedItem().toString().matches("Select Doctor type")) {
                    Toast toast = Toast.makeText(getApplicationContext(),
                            "Select Doctor Type!",
                            Toast.LENGTH_LONG);
                    toast.show();
                                            ...
                                            .addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(DataSnapshot dataSnapshot) {
                                                    ...
                                                    if (p == 1) {
                                                        ...
                                                        String phoneNumber = "+91" + phonenum;
                                                        Intent intent = new Intent(CreateAccount.this, ProfileDoctorsProvider.class);
                                                        intent.putExtra("phonenumber", phoneNumber);
                                                        intent.putExtras(bundle);
                                                        startActivity(intent);
                                                    } else {
        ...
        categoryspinner.setAdapter(adapt);
        categoryspinner.setOnItemSelectedListener(this);

        Spinner doctorSpinner = (Spinner) findViewById(R.id.doctor_categories);
        ArrayAdapter<CharSequence> adapter2 = ArrayAdapter.createFromResource(this,
                R.array.Categories_doctors, android.R.layout.simple_spinner_item);
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.checkCustomer:
                ...
                doctorCategories.setVisibility(View.GONE);
                break;
            case R.id.checkServiceProvider:
                if (checked)
                    next.setVisibility(View.VISIBLE);
                docNext.setVisibility(View.GONE);
                submit.setVisibility(View.INVISIBLE);
                categories.setVisibility(View.VISIBLE);
                doctorCategories.setVisibility(View.GONE);
                break;
            case R.id.checkDoctor:
                if (checked)
                    docNext.setVisibility(View.VISIBLE);
                next.setVisibility(View.GONE);
                submit.setVisibility(View.INVISIBLE);
                categories.setVisibility(View.GONE);
                doctorCategories.setVisibility(View.VISIBLE);
                break;
        }
    }
