...
public class ProfileDoctorsProvider extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_doctors_provider);
            ...
            profileRef.putFile(filePath1)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(ProfileDoctorsProvider.this, "Uploaded", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        if (view == next) {
            ...
            if (count < 2)
                Toast.makeText(ProfileDoctorsProvider.this, "Upload all required files", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(ProfileDoctorsProvider.this, SignUp_Doctor.class);
