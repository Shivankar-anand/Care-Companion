...
public class DocShowSentRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doc_show_sent_request);
        ...
        if(type.equals("Doctor_type")){
            databaseReference = FirebaseDatabase.getInstance().getReference().child("Doctors_type").child(userid);}
        else {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(DocShowSentRequest.this).load(s.getProfilePicUrl()).into(dp);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    requestAdapter = new RequestAdapter(DocShowSentRequest.this,mchat,imageurl);
