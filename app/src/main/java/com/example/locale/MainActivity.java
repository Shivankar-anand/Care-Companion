...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseUser != null) {
            ...
            DatabaseReference database = FirebaseDatabase.getInstance().getReference("Patients");
            database.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (count == 1) {
                        ...
                        DatabaseReference database1 = FirebaseDatabase.getInstance().getReference("Doctors");
...
//                                    finish();
                                    ...
                                    DatabaseReference database2 = FirebaseDatabase.getInstance().getReference("Doctors_type");
                                    database2.addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            if (cont == 1) {
                                                ...
                                                Toast.makeText(MainActivity.this, "Not verified yet", Toast.LENGTH_SHORT).show();
                                                Intent intent = new Intent(MainActivity.this, PendingDoctors.class);
                                                startActivity(intent);
                                                finish();
