...
public class AskLoactionDoctor extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ask_loaction_doctor);
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mapFragment.getMapAsync(AskLoactionDoctor.this);
                }
            }
        });
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String experience = bundle.getString("yearsOfExperience");
                ...
                FirebaseDatabase.getInstance().getReference("Doctors_type")
                        .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                        .setValue(sp).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(AskLoactionDoctor.this, "Registered Successfully", Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(AskLoactionDoctor.this, PendingDoctors.class);
